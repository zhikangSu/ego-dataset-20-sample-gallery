...
def check_pages() -> None:
    ...
    assert gallery[0].get("src") == "index.html?embed=1&viewer=scene-dist-v2#gallery"
    assert 'src="gallery.js?v=scene-dist-v2"' in index, "versioned gallery application script is missing"
    assert 'src="data/catalog.js?v=scene-dist-v2"' in index, "versioned catalog script is missing"
    assert 'src="data/scenes.js?v=scene-dist-v2"' in index, "scene distribution data script is missing"
